...
struct zzmoove_profile zzmoove_profiles[] = {
	{
		...
		1190400,	// inputboost_punch_freq (0=disable, range from 0 to freq->max in khz)
...
#endif /* ENABLE_INPUTBOOSTER */
#ifdef ENABLE_MUSIC_LIMITS
		1094400,	// music_max_freq (0=disable, range from 0 to freq->max in khz)
	...
	},
	{
		...
		787200,		// down_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		998400,	// down_threshold_hotplug_freq2
		1190400,	// down_threshold_hotplug_freq3
#endif /* (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8) */
#if (MAX_CORES == 6 || MAX_CORES == 8)
		0,		// down_threshold_hotplug_freq4
	...
	},
	{
		...
		55,		// down_threshold_hotplug7
#endif /* (MAX_CORES == 8) */
		384000,		// down_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		...
		68,		// up_threshold_hotplug7
#endif /* (MAX_CORES == 8) */
		384000,		// up_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		1094400,	// up_threshold_hotplug_freq2
		1190400,	// up_threshold_hotplug_freq3
	...
	},
	{
		...
		95,		// scaling_fastdown_up_threshold
		90,		// scaling_fastdown_down_threshold
		384000,		// scaling_responsiveness_freq
